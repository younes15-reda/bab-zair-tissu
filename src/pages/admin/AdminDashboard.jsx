  ...
  return (
    <div className="space-y-6 max-w-xl">
      ...
      <div className="bg-slate-800/60 border border-slate-700/50 rounded-2xl p-5 space-y-4">
        ...
        {featuredProduct ? (
          <div className="bg-amber-500/10 border border-amber-500/20 rounded-xl p-4 text-xs text-amber-300 font-bold space-y-2">
            <p>⭐ L'image principale est actuellement liée au produit vedette sélectionné ci-dessous :</p>
            <p className="text-white text-sm">« {featuredProduct.nameFr || featuredProduct.nameAr} »</p>
            <p className="text-[10.5px] text-slate-400 font-normal leading-relaxed">
              L'image du produit vedette s'affiche automatiquement en tant qu'image Hero de l'accueil. Les clics sur le Hero redirigent directement vers ses détails. Pour utiliser une image d'accueil personnalisée, retirez le produit vedette ci-dessous.
            </p>
          </div>
        ) : (
